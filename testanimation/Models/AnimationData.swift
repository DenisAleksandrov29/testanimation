...
struct AnimationData {
    static let animations = [
        ...
        "fadeInDown", "fadeInUp", "zoomIn","zoomOut", "fall", "shake", "flipX",
        "flipY", "morph", "squeeze", "flash", "wobble", "swing"]
    
    static let curves = [
        "easeOut", "easeInOut", "linear", "spring", "easeInSine","easeInSine",
        ...
        "easeInOutQuart","easeInQuint", "easeOutQuint", "easeInOutQuint", "easeInOutQuint",
        "easeInExpo", "easeOutExpo", "easeInOutExpo", "easeInCirc","easeInCirc",
